...
function App() {
  ...
  useEffect(() => {
    ...
    (window as any).deployTroop = (type: keyof typeof army) => {
      setArmy(prev => {
        const housing = { warrior: 1, archer: 1, giant: 5, ward: 3, recursion: 3, chronoswarm: 2 };
  ...
  const handleTrainTroop = (type: 'warrior' | 'archer' | 'giant' | 'ward' | 'recursion' | 'chronoswarm') => {
    const costs = { warrior: 25, archer: 40, giant: 150, ward: 80, recursion: 80, chronoswarm: 60 };
    const housing = { warrior: 1, archer: 1, giant: 5, ward: 3, recursion: 3, chronoswarm: 2 };
  ...
  const handleStartAttack = () => {
    const total = army.warrior + army.archer + army.giant + army.ward + army.recursion + army.chronoswarm;
    if (total === 0) {
            ...
            <div className="modal-body">
              ...
              <div className="troop-list">
                {[
                  ...
                  { id: 'recursion', name: 'Recursion', cost: 80, space: 3, desc: 'Splits into two copies on death.' },
                  { id: 'chronoswarm', name: 'Chrono Swarm', cost: 60, space: 2, desc: 'Speeds up nearby allies.' },
                ].map(t => (
